...
If the grade is A or B with no improvement suggestions, congratulate and suggest publishing with `better-skill-publish`. If not installed: `npx skills add psylch/better-skills@better-skill-publish -g -y`
